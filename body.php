						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									...
									<li><a data-toggle="tab" href="#tab1">Lotion</a></li>
									<li><a data-toggle="tab" href="#tab1">Skin</a></li>
									<li><a data-toggle="tab" href="#tab1">Hair Care</a></li>
								</ul>
							</div>
						</div>
					</div>
